...
public class DataStore {
    ...
    /**
     * loadUsers loads the user in the user array
     */
    ...
    /**
     * loadWeblinks loads the web links ito the bookmarks array
     */
    ...
    /**
     * loadMovies loads movies into the bookmarks array
     */
    ...
    /**
     * loadBooks loads books into the bookmark array
     */
    private static void loadBooks() {
        ...
        bookmarks[2][3] = BookmarkManager.getInstance().createBook(4003,	"Head First Design Patterns", 2004, "O'Reilly Media"	,new String[]{ "Bert Bates", "Kathy Sierra", "Elisabeth Robson"}, BookGenre.TECHNICAl, 4.5);
